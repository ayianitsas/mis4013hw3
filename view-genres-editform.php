    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="">
                 ...
                 <div class="mb-3">
                        <label for="gPopYear<?php echo $genre['genre_id']; ?>" class="form-label">Genre Popular Year</label>
                        <input type="text" class="form-control" id="gPopYear<?php echo $genre['genre_id']; ?>" name="gPopYear" value="<?php echo $genre['popular_year']; ?>">
                 </div>
